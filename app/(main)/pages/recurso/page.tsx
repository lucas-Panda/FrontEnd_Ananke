        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={recursoDialog} style={{ width: '450px' }} header="Recursos" modal className="p-fluid" footer={recursoDialogFooter} onHide={hideDialog}>
                        <form onSubmit={(e) => { e.preventDefault(); saveRecurso(); }}>
                            ...
                            <div className="field">
                                ...
                                />
                                {submitted && !recurso.nome && <small className="p-invalid">nome Obrigatorio.</small>}
                            </div>
                    ...
                    <Dialog visible={deleteRecursoDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteRecursoDialogFooter} onHide={hideDeleteRecursoDialog}>
                        <div className="flex align-items-center justify-content-center">
                            ...
                            {recurso && (
                                <span>
                                    Você realmente deseja deletar o Recurso <b>{recurso.nome}</b>?
                                </span>
                            )}
                        </div>
                    </Dialog>
                    ...
                    <Dialog visible={deleteRecursosDialog} style={{ width: '450px' }} header="Confirmar" modal footer={deleteRecursosDialogFooter} onHide={hideDeleteRecursosDialog}>
                        <div className="flex align-items-center justify-content-center">
                            <i className="pi pi-exclamation-triangle mr-3" style={{ fontSize: '2rem' }} />
                            {recursos && <span>Você realmente deseja deletar os recursos selecionados?</span>}
                        </div>
                    </Dialog>
                </div>
            </div>
